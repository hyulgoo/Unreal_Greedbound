...
{
    UGBAsyncAction_PushSoftWidget* PushAction = UGBAsyncAction_PushSoftWidget::PushSoftWidget(this, GetOwningPlayerController(), UGBUIFunctionLibrary::GetSoftWidgetClassByTag(GBTag::UI_Widget_MainMenuScreen), GBTag::UI_WidgetStack_GameMenu);
    if (PushAction)
    {
        PushAction->Activate();
    }
