...
#include "GBGA_RegenStamina.generated.h"

UCLASS()
class GREEDBOUND_API UGBGA_RegenStamina : public UGBGA_Base
{
    GENERATED_BODY()

public:
    UGBGA_RegenStamina(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
